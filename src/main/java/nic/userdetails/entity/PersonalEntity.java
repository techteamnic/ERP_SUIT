...
public class PersonalEntity implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "personal_info_id")
	@SequenceGenerator(name = "personal_info_id", sequenceName = "personal_info_id_seq", allocationSize = 1)
