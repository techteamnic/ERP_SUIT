...
public class AppointmentModel2 implements Serializable{
	...
	private String applicatint_id_no;
	...
	private Integer event_audiance_type;
...
//	private Integer additional_visitors;
	...
	private MultipartFile message_document;
	...
	public Integer getEvent_audiance_type() {
		return event_audiance_type;
	}
	public void setEvent_audiance_type(Integer event_audiance_type) {
	...
	public void setMessage_notes(String message_notes) {
		this.message_notes = message_notes;
	}
	public MultipartFile getMessage_document() {
		return message_document;
	}
	public void setMessage_document(MultipartFile message_document) {
	...
	public String getApplicatint_id_no() {
		return applicatint_id_no;
	}
	public void setApplicatint_id_no(String applicatint_id_no) {
		this.applicatint_id_no = applicatint_id_no;
	}
	@Override
	public String toString() {
		return "AppointmentModel [visitor_id=" + visitor_id + ", application_id=" + application_id + ", applicant_type="
				...
				+ ", applicatint_id_no=" + applicatint_id_no + ", gender=" + gender + ", district=" + district
				+ ", district_other=" + district_other + ", full_address=" + full_address + ", mobile_no=" + mobile_no
				+ ", alternate_no=" + alternate_no + ", email=" + email + ", pref_date_1=" + pref_date_1
				+ ", pref_date_2=" + pref_date_2 + ", pref_date_3=" + pref_date_3 + ", visitor_document="
				+ visitor_document + ", visit_description=" + visit_description + ", visit_support_document="
				+ visit_support_document + ", department=" + department + ", designation=" + designation
				+ ", organisation_name=" + organisation_name + ", org_reg_number=" + org_reg_number
				+ ", political_party_name=" + political_party_name + ", party_reg_number=" + party_reg_number
				+ ", event_name=" + event_name + ", event_description=" + event_description + ", event_location="
				+ event_location + ", event_type_invitation=" + event_type_invitation + ", event_coordinator_name="
				+ event_coordinator_name + ", event_coordinator_mobile=" + event_coordinator_mobile
				+ ", dais_sharing_no=" + dais_sharing_no + ", dais_sharing_names=" + dais_sharing_names
				+ ", event_desc_document=" + event_desc_document + ", event_expected_audience="
				+ event_expected_audience + ", event_audiance_type=" + event_audiance_type + ", event_date="
				+ event_date + ", event_time=" + event_time + ", event_duration=" + event_duration
				+ ", addl_visitor_name=" + Arrays.toString(addl_visitor_name) + ", addl_visitor_id_number="
				+ Arrays.toString(addl_visitor_id_number) + ", addl_visitor_mobile="
				+ Arrays.toString(addl_visitor_mobile) + ", addl_visitor_document="
				+ Arrays.toString(addl_visitor_document) + ", message_notes=" + message_notes + ", message_document="
				+ message_document + ", otp=" + otp + ", captcha=" + captcha + ", receipt_mode=" + receipt_mode
				+ ", receipt_by=" + receipt_by + ", receipt_date=" + receipt_date + ", receipt_remarks="
