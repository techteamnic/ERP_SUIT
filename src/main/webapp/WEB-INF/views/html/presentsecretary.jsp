...
<div class="col-md-offset-1 col-md-10">
						...
						<b>Secretary to Governor</b></a></h3>

                          <hr>
                <div class="secretary">    
    <h4 align="center" style="color:#000080;">K. SURENDRA MOHAN, IAS</h4>
    <p>
        <img src="img/KLN_4003.jpg" alt="apvn sarma" style="float:right; width:300px; padding-left:20px;">
        Shri Surendra Mohan IAS, native of Nalgonda district (Telangana) is an Engineering Graduate of class of 1991 from REC Warangal (now known as NIT Warangal) from Computer Science branch.<br><br>

        He joined state civil service cadre of the then unified state of Andhra Pradesh in 1996 as Deputy Collector.<br><br>

        As Deputy Collector on field, he held various important assignments such as Revenue Divisional Officer of Jagtiyal and Karimnagar Divisions.<br><br>

        Then-after he served as Project Director DRDA (District Rural Development Agency) and Project Director CMRO (Computerization of Mandal Revenue Offices).<br><br>

        Promoted to prestigious Indian Administrative Service w.e.f 2006 Shri Surendra Mohan then served as Joint Collector of Khammam and Hyderabad district(s) (Telangana).<br><br>

        He then served as Additional Commissioner (IT &amp; Elections) at Greater Hyderabad Municipal Corporation (GHMC).<br><br>

        He was then appointed as 1st Collector &amp; District Magistrate of newly formed Suryapet District (Telangana) from October 2016 to December 2018.<br><br>

        He has taken charge as Secretary to Hon'ble Governor of Telangana w.e.f 15th March 2019.<br>
    </p>
<br>
</div>           
