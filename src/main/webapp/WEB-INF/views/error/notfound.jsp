	...
	<div id="notfound">
		<div class="notfound">
			<c:if test="${not empty error_msg}">
				<h2>${error_msg.message}</h2>
			</c:if>
<!-- 			<h2>File Not Found</h2> -->
			<c:if test="${not empty no_doc and no_doc}">
			<p>Sorry, but the file you are looking for does not exist, have been removed. name changed or is temporarily unavailable
			(OR) <strong>Application submitted by ADC.</strong>
			</p>
			<img width="20%" height="30%" alt="NO DOC FOUND" src="${pageContext.request.contextPath}/img/no_doc.png">
			<br>
			</c:if>
